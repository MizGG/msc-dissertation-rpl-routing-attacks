...
def main() -> None:
    ...
    parser.add_argument("--robustness", type=Path, default=Path("experiments/robustness_campaign_v1/features/routing_window_features.csv"))
    parser.add_argument("--out", type=Path, default=Path("experiments/robustness_campaign_v1/results/ids_evaluation.csv"))
