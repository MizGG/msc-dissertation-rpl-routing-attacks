...
Total CART cross-attack pairs with zero attack recall: 44.
Total CART cross-attack pairs with F1 >= 0.8: 2.
...
- train dio_suppression -> test dis_flood: accuracy=0.7222, recall=0.0, f1=0.0
- train dio_suppression -> test grayhole: accuracy=0.7222, recall=0.0, f1=0.0
- train dio_suppression -> test increase_rank: accuracy=0.7222, recall=0.0, f1=0.0
...
- train dio_suppression -> test worst_parent: accuracy=0.7222, recall=0.0, f1=0.0
...
- train grayhole -> test blackhole: accuracy=0.7222, recall=0.0, f1=0.0
- plus 24 more zero-recall pairs in the CSV.
