...
Total CART cross-attack pairs with zero attack recall: 48.
Total CART cross-attack pairs with F1 >= 0.8: 6.
...
- train blackhole -> test sybil: accuracy=0.7222, recall=0.0, f1=0.0
...
- train dio_suppression -> test sybil: accuracy=0.6111, recall=0.0, f1=0.0
...
- plus 28 more zero-recall pairs in the CSV.
