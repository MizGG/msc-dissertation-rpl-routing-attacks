...
FAMILIES = {
    "blackhole": {
        ...
        "attack_source": "../blackhole-router.c",
        "control_source": "../blackhole-control-router.c",
    },
    "sinkhole": {
        "prefix": "SH",
        "template": REPOSITORY / "experiments/sinkhole/final_corrected_240s_540s/configs/SH_{mode}_N16_SEED{seed}.csc",
        "attack_source": "../sinkhole-router.c",
        "control_source": "../sinkhole-control-router.c",
    },
    "sybil": {
        "prefix": "SYBIL",
        "template": REPOSITORY / "experiments/sybil_attack_v1/configs/SYBIL_{mode}_N16_SEED{seed}.csc",
        "attack_source": "../sybil-router.c",
        "control_source": "../sybil-control-router.c",
    },
}
CONDITIONS = {
...
def replace_common_sources(text: str) -> str:
    return (text
            .replace("[CONFIG_DIR]/../code/udp-server.c", "[CONFIG_DIR]/../udp-server.c")
            .replace("[CONFIG_DIR]/../code/udp-client.c", "[CONFIG_DIR]/../udp-client.c"))


def enable_rpl_telemetry(text: str) -> str:
    return text.replace(
        "TARGET=cooja</commands>",
        "TARGET=cooja CFLAGS+=-DLOG_CONF_LEVEL_RPL=LOG_LEVEL_INFO</commands>",
    )
