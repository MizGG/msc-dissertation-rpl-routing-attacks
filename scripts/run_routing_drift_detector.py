...
def main() -> None:
    ...
    parser.add_argument(
        "--features",
        type=Path,
        default=Path("experiments/routing_features_v1/features/routing_window_features.csv"),
    )
    parser.add_argument(
        "--out-dir", type=Path, default=Path("experiments/routing_features_v1/results")
    )
