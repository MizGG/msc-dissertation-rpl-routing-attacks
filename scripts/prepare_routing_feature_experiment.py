...
BLACKHOLE_FINAL = REPO / "experiments/blackhole/final_corrected_240s_540s"
SINKHOLE_FINAL = REPO / "experiments/sinkhole/final_corrected_240s_540s"
...
def main() -> None:
    ...
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("experiments/routing_features_v1"),
    )
