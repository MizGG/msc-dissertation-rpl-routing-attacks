...
def main() -> None:
    ...
    parser.add_argument("--features", type=Path, default=Path("experiments/features/window_features.csv"))
    parser.add_argument("--out-dir", type=Path, default=Path("experiments/ml_window"))
