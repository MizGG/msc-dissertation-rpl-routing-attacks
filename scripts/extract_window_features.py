...
RUN_DIRS = [
    Path("experiments/blackhole/final_corrected_240s_540s/runs"),
    Path("experiments/sinkhole/final_corrected_240s_540s/runs"),
]
...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=Path("experiments/features/window_features.csv"))
